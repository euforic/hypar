...
Hypar.prototype.onopentagname = function(name) {
  ...
  this._onopentag && (this._attribs = {});
};

Hypar.prototype.onopentagend = function() {
  if (this._attribname !== '') this.onattribvalue('');
  if (this._attribs) {
    if (this._onopentag) this._onopentag({
        name: this._tagname,
        attributes: this._attribs
      });
    this._attribs = null;
  }
  this._tagname = '';
  ...
  if (this._stack.length && (!(name in voidElements))) {
    ...
    if (pos !== -1) {
      if (this._onclosetag) {
        ...
        while (pos--) this._onclosetag(this._stack.pop());
...
Hypar.prototype._emitToken = function(name) {
  this[name](this._buffer.substring(this._sectionStart, this._index));
